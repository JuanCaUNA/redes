...
def get_database_metrics():
    ...
    try:
        ...
        type_distribution = (
            ...
            .filter(Transaction.created_at >= twenty_four_hours_ago)
        ...
        return jsonify(
            {
                ...
                "data": {
                    ...
                    "recent_activity": {"transactions_last_hour": recent_transactions},
                    "status_distribution": [
...
def get_active_alerts():
    ...
    try:
        ...
        for alert in alerts:
            severity = "warning"
            if any(
                keyword in alert.lower() for keyword in ["critical", "failed", "error"]
            ):
                severity = "critical"
        ...
        return jsonify(
            {
                ...
                "data": {
                    ...
                    "critical_count": len(
                        [a for a in categorized_alerts if a["severity"] == "critical"]
                    ),
                    "warning_count": len(
                        [a for a in categorized_alerts if a["severity"] == "warning"]
                    ),
                    "timestamp": datetime.utcnow().isoformat(),
                },
            }
        ...
        return jsonify(
            {
                ...
                "data": {
                    ...
                    "database_status": health_status.get("database", {}).get(
                        "status", "unknown"
                    ),
