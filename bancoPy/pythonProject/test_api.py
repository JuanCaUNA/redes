...
def test_transactions_api():
    ...
    if response.status_code == 200:
        ...
        if transactions:
            ...
            print(
                f"   Latest: {latest['amount']} {latest['currency']} - {latest['status']}"
            )
...
def test_sinpe_transfer():
    ...
    transfer_data = {
        ...
        "sender": {"phone": "88887777", "bank_code": "152", "name": "Juan Pérez"},
        "receiver": {
            "phone": "88886666",
            "bank_code": "152",
...
def test_authentication():
    ...
    # Test login
    login_data = {"username": "juan_perez", "password": "password123"}
